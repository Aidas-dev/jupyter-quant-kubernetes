...
LABEL org.opencontainers.image.description="A cloud-native Jupyter quant research environment for Kubernetes and JupyterHub. Based on the original jupyter-quant by @gnzsnz. "
